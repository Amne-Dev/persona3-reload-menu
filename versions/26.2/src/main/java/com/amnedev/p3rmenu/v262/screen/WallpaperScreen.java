package com.amnedev.p3rmenu.v262.screen;

import com.amnedev.p3rmenu.v262.P3RGraphics;
import com.amnedev.p3rmenu.v262.Transition;
import com.amnedev.p3rmenu.v262.WallpaperManager;
import com.amnedev.p3rmenu.v262.WallpaperManager.Option;
...
public final class WallpaperScreen extends Screen {
    ...
    private void drawRow(GuiGraphicsExtractor graphics, int index, int y, float intro) {
    ...
    private void drawFooter(GuiGraphicsExtractor graphics, String value, int x, int y,
    ...
    private void closeWithTransition() {
        if (!Transition.isActive()) {
            Transition.startOut(Component.literal("BACK"), () -> minecraft.gui.setScreen(parent));
        }
    }
