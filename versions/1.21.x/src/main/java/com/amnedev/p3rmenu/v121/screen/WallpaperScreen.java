...
import com.amnedev.p3rmenu.v121.WallpaperManager;
import com.amnedev.p3rmenu.v121.WallpaperManager.Option;
...
public final class WallpaperScreen extends Screen {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int buttonCode) {
        ...
        int firstY = rowY(0);
        if (mouseX >= width * 0.055F && mouseX <= width * 0.67F && mouseY >= firstY) {
            int visible = (int) ((mouseY - firstY) / rowStep());
