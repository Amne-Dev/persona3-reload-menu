...
public final class P3RGraphics {
    ...
    public static final int CONFIG_PINK = 0xFFFF3E98;
    ...
    public static void wallpaper(GuiGraphics graphics, int width, int height) {
    ...
    public static void logo(GuiGraphics graphics, int width, int height, float intro) {
    ...
    public static void skewedRect(GuiGraphics graphics, int x, int y,
    ...
    public static void configBackground(GuiGraphics graphics, int width, int height,
            float intro) {
    ...
    public static void configHeader(GuiGraphics graphics, Font font, String title,
        ...
        graphics.drawString(font, heading, 0, 0, alpha(0xFF58D7E5, intro), true);
        graphics.pose().popMatrix();
    ...
    public static void configFooter(GuiGraphics graphics, Font font,
        ...
        graphics.drawString(font, bold("CONFIG"), 0, 0,
    ...
    public static void configSelection(GuiGraphics graphics, int x, int y,
        ...
        graphics.fill(x - 3, y, x, y + height, alpha(CONFIG_PINK, eased));
    }
    ...
    public static void listBackground(GuiGraphics graphics, int width, int height,
            float intro) {
        wallpaper(graphics, width, height);
    ...
    public static void listHeader(GuiGraphics graphics, Font font,
    ...
    private static void triangle(GuiGraphics graphics,
    ...
    private static void slantedPanel(GuiGraphics graphics,
    ...
    public static void fittedText(GuiGraphics graphics, Font font, Component text,
        ...
        graphics.drawString(font, text, 0, 0, color, shadow && !isDarkText(color));
        graphics.pose().popMatrix();
    }
